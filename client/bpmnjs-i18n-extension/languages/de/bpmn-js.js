...
export default {
    ...
    'Append MessageIntermediateCatchEvent': 'Nachrichten-Zwischenereignis (fangend) anfügen',
    ...
    'Append SignalIntermediateCatchEvent': 'Signal-Zwischenereignis (fangend) anfügen',
    'Append task': 'Aufgabe anfügen',
    'Append Task': 'Aufgabe anfügen',
    'Append timer intermediate catch event': 'Zeit-Zwischenereignis (fangend) anfügen',
    'Append TimerIntermediateCatchEvent': 'Zeit-Zwischenereignis (fangend) anfügen',
    ...
    'Complex gateway': 'Komplexes Gateway',    'Conditional boundary event (non-interrupting)': 'Bedingungsabhängiges Grenz-Ereignis (nicht unterbrechend)',
    ...
    'Escalation intermediate throw event': 'Eskalations-Zwischenereignis (ausgelöst)',
    ...
    'Intermediate throw event': 'Zwischenereignis (ausgelöst)',
    'Link intermediate catch event': 'Linkereignis (eingetreten)',
    'Link intermediate throw event': 'Linkereignis (ausgelöst)',
    'Loop': 'Schleife',
    'Manual task': 'Benutzer-Aufgabe',
    ...
    'Message intermediate catch event': 'Nachrichtenerignis (eingetreten)',
    'Message intermediate throw event': 'Nachrichtenerignis (ausgelöst)',
    ...
    'Receive task': 'Aufgabe',    'Remove': 'Entfernen',
    'Script task': 'Skriptaufgabe',    'Send task': 'Sendeaufgabe',
    ...
    'Timer intermediate catch event': 'Timereignis, Zeitereignis',
    'Timer start event (non-interrupting)': 'Zeitereignis (nicht unterbrechend)',
    'Timer start event': 'Zeitereignis',
